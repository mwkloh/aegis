...
> **Local-first, guarded cognitive system.** A personal AI assistant whose tool execution is correct *by architecture*, not by model capability — built to run usefully on small open-weights models (7B–13B) with frontier APIs as optional accelerators.
